...
import { runPosixShell, sidecarWorkspaceRoot, workspaceRoot } from '../agents/_workspace.ts'
  ...
  return {
    ...
    commands: {
      async run(command, options = {}) {
        ...
        return await runPosixShell(trimmed, cwd, Math.max(1, Number(options.timeout || 30)))
      },
    },
    getHost() {
      return undefined
