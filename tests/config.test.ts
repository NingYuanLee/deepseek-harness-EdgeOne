...
test('API proxy refuses model credential writes so keys stay in the environment', async () => {
  ...
  assert.match(source, /\/api\/sandbox\/files/)
  assert.match(source, /listSandboxFiles/)
  assert.match(source, /downloadSandboxFile/)
  assert.match(source, /uploadSandboxFile/)
  assert.match(source, /deleteSandboxFile/)
  assert.match(source, /handleSandboxFile/)
